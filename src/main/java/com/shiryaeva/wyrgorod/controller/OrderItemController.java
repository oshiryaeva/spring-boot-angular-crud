...
public class OrderItemController {
    ...
    private String applicationName = "orderItem";
    ...
    public ResponseEntity<OrderItem> createOrderItem(@Valid @RequestBody OrderItem orderItem) throws URISyntaxException {
        ...
        return ResponseEntity
                .created(new URI("/orderItems/" + result.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
                .body(result);
    }

    /**
     * {@code PUT  /orderItems/:id} : Updates an existing orderItem.
     *
    ...
    public ResponseEntity<OrderItem> updateOrderItem(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody OrderItem orderItem)
    ...
    /**
     * {@code PATCH  /orderItems/:id} : Partial updates given fields of an existing orderItem, field will ignore if it is null
     *
     * @param id the id of the orderItem to save.
     * @param orderItem the orderItem to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated orderItem,
    ...
    /**
     * {@code GET  /orderItems} : get all the orderItems.
     *
