...
describe('Component Tests', () => {
  describe('NewsItem Management Detail Component', () => {
    let comp: NewsItemDetailComponent;
        ...
        providers: [
          {
            ...
            useValue: { data: of({ newsItem: { id: 123 } }) },
          },
        ],
      })
        .overrideTemplate(NewsItemDetailComponent, '')
        .compileComponents();
    ...
    describe('OnInit', () => {
      it('Should load newsItem on init', () => {
        // WHEN
        comp.ngOnInit();

        // THEN
        expect(comp.newsItem).toEqual(expect.objectContaining({ id: 123 }));
      });
    });
