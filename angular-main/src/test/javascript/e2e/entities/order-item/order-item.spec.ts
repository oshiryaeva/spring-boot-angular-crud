...
describe('OrderItem e2e test', () => {
  ...
  it('should load create OrderItem page', async () => {
    ...
    expect(await orderItemUpdatePage.getPageTitle()).to.eq('Create or edit a Order Item');
  ...
  it('should delete last OrderItem', async () => {
    ...
    expect(await orderItemDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Order Item?');
